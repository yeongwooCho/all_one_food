...
class MyColor {
  // Main
  static const primary = Color(0xFFFF9C55);
  static const secondary = Color(0xFFFF9A85);
  static const third = Color(0xFFE65527);
  ...
  static const barrier = Color(0x3F1C1C1E);
  static const empty = Color(0x00FFFFFF);
  static const shadow = Color(0x3F000000);
  static const red = Color(0xFFFA6230);
}
